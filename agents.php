  ...
  <div class="col-lg-8  col-lg-offset-2 col-sm-12">
	<?php while($data = mysql_fetch_assoc($sel))
	{
      ...
      <div class="row">
        ...
        <div class="col-lg-2 col-sm-2 "><img src="images/agents/<?php echo $data['image']; ?>" class="img-responsive"  alt="agent name"></div>
        <div class="col-lg-7 col-sm-7 "><h4><?php echo $data['name']; ?></h4><p><?php echo stripslashes($data['description']); ?></p></div>
        <div class="col-lg-3 col-sm-3 "><span class="glyphicon glyphicon-envelope"></span> <a href="mailto:<?php echo $data['email']; ?>"><?php echo $data['email']; ?></a><br>
        <span class="glyphicon glyphicon-earphone"></span> <?php echo $data['phone']; ?></div>
      </div>
      <?php
	}
